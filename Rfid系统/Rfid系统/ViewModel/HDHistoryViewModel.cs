...
{
    public class HDHistoryViewModel : NotificationObject
    {
        public HDHistoryViewModel(MainControl mainControl)
        {
                ...
                return input ?? (input = new DelegateCommand<System.Windows.Controls.TextBox>((data) =>
                {
                    ...
                    switch (SelectIndex)
                    {
                        ...
                        case 1:
                            return;
                        case 2:
                            urlParamant.Add("periodicalNum", data.Text);
                            break;
                        default:
                ...
                return firstCommand ?? (firstCommand = new DelegateCommand(() =>
                {
                    ...
                    switch (SelectIndex)
                    {
                        ...
                        case 1:
                            ...
                            break;
                        case 2:
                            urlParamant.Add("periodicalNum", Parameter);
                            break;
                        default:
                            urlParamant.Add("beginTime", sDate);
                            urlParamant.Add("endTime", eDate);
        ...
        public bool GetData(object paramant, int Querypage)
        {
            ...
            HDHistoryDAL hDHistoryDAL = new HDHistoryDAL();
            if (hDHistoryDAL.HDHistory(ref errorMsg))
            {
