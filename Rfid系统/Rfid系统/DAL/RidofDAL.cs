...
{
    public class RidofDAL
    {
        public bool Ridof(ref object errorMsg)
        {
            try
            {
                string url = string.Format("{0}{1}", ServerSetting.UrlPath, "periodicalmodule/periodicalTbCollectionInfo/ridOf");
